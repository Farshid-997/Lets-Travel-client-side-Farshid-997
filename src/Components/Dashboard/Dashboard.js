...
const Dashboard = () => {
  ...
  return (
    <div id="main">
      <Button style={{ width: "", margin: "5px" }} onClick={openNav}>
        ☰ Open{" "}
      </Button>
        ...
        <Row>
          <Col>
            <div id="sidenav" className="sidenav">
              <Button class="openbtn" onClick={closeNav}>
                X
              </Button>
              {user.email && (
                <div>
                  ...
                  <br />
                  <Link to={`${url}/addblog`}>Add Blogs</Link>
                  <br />
              ...
              {admin && (
                <div>
                  ...
                  <br />
                  <Link to={`${url}/confirmorders`}>User Confirm Orders</Link>
                  <br />
                  <Link to={`${url}/makeadmin`}>Make Admin</Link>
                  <br />
                  <Link to={`${url}/showcontact`}>User Contact</Link>
                  <br />
