  ...
  return (
    <div style={{ marginTop: "70px" }}>
      ...
      <CardGroup>
        <Card style={{ margin: "15px" }}>
          ...
          <Card.Body>
            <Card.Title style={{ color: "black", fontWeight: "bold" }}>
              New Travel Package In London
            </Card.Title>
            <Card.Text style={{ color: "black" }}>
              Get this booking offer and you will get the opportunity to visit
              London.
            </Card.Text>
          </Card.Body>
          <Card.Footer>
        ...
        <Card style={{ margin: "15px" }} classname="card">
          <Card.Img variant="top" src={img2} />
          <Card.Body>
            <Card.Title style={{ color: "black", fontWeight: "bold" }}>
              New Travel Package In USA
            </Card.Title>
            <Card.Text style={{ color: "black" }}>
              Get this booking offer and you will get the opportunity to visit
              USA.
        ...
        <Card style={{ margin: "15px" }}>
          ...
          <Card.Body>
            <Card.Title style={{ color: "black", fontWeight: "bold" }}>
              New Travel Package In Australia
            </Card.Title>
            <Card.Text style={{ color: "black" }}>
              Get this booking offer and you will get the opportunity to visit
              Australia
